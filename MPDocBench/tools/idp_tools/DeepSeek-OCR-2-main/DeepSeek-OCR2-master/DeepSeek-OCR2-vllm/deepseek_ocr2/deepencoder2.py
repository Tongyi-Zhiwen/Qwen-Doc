...
_USE_NEW_MASK_API = version.parse(transformers.__version__) >= version.parse("4.53.0")
    ...
    def _create_custom_model(self, Qwen2Model, config):
        ...
        class CustomQwen2ModelInner(Qwen2Model):
            ...
            def forward(
                ...
                if _USE_NEW_MASK_API and token_type_ids is not None:
                    input_tensor = inputs_embeds
                    if input_tensor is None and input_ids is not None:
                    ...
                    if input_tensor is not None:
                        ...
                        custom_mask = self._create_custom_4d_mask(
                        ...
                        if attention_mask is not None and isinstance(attention_mask, torch.Tensor) and attention_mask.dim() == 2:
                            ...
                            custom_mask = custom_mask + padding_mask
                        attention_mask = {
                            "full_attention": custom_mask,
                            "sliding_attention": custom_mask,
                        }
