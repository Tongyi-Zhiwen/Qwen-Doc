...
def layoutjson2md(image: Image.Image, cells: list, text_key: str = 'text', no_page_hf: bool = False, page_id = None) -> str:
    """
    ...
    Args:
        ...
        page_id: Page identifier for image naming.
    Returns:
    ...
    for i, cell in enumerate(cells):
        ...
        if cell['category'] == 'Picture':
            if page_id is None:
                ...
                # 修正：f-string格式化
                image_text = f"![](page{page_id}_{x1_norm}_{y1_norm}_{x2_norm}_{y2_norm}.jpg)"
